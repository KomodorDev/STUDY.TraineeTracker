...
namespace TraineeTracker.Services.TraineeLessonStates.States {
    ...
    /// <summary>
    /// Represents the 'Accepted' state of a trainee lesson and defines the allowed transitions from this state.
    /// </summary>
    /// <remarks>
    ...
    public class AcceptedState : ITraineeLessonState {
        ...
        // ----------------------------------------------
        /// <summary>
        /// Returns a list of lesson states that the current user is allowed to transition to from the 'Accepted' state.
        /// </summary>
        ...
        /// from the current 'Accepted' state based on the user's role.
        /// </returns>
        /// <remarks>
        /// Code Ownership: Simon Hinterreiter (hintsimo)
        /// </remarks>
        ...
        // ----------------------------------------------
        /// <summary>
        /// Attempts to transition from the 'Accepted' state to the specified target state, 
