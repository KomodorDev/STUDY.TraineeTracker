...
namespace TraineeTracker.Services.TraineeLessonStates.States {
    ...
    /// <summary>
    /// Represents the 'Finished' state of a trainee lesson and defines the allowed transitions from this state.
    /// </summary>
    /// <remarks>
    ...
    public class FinishedState : ITraineeLessonState {
        ...
        // ----------------------------------------------
        /// <summary>
        /// Returns a list of lesson states that the current user is allowed to transition to from the 'Finished' state.
        /// </summary>
        ...
        /// from the current 'Finished' state based on the user's role.
        /// </returns>
        /// <remarks>
        /// Code Ownership: Simon Hinterreiter (hintsimo)
        /// </remarks>
        ...
        // ----------------------------------------------
        /// <summary>
        /// Attempts to transition from the 'Finished' state to the specified target state, 
