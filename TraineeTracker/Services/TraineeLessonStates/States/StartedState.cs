...
namespace TraineeTracker.Services.TraineeLessonStates.States {
    ...
    /// <summary>
    /// Represents the 'Started' state of a trainee lesson and defines the allowed transitions from this state.
    /// </summary>
    /// <remarks>
    ...
    public class StartedState : ITraineeLessonState {
        ...
        // ----------------------------------------------
        /// <summary>
        /// Returns a list of lesson states that the current user is allowed to transition to from the 'Started' state.
        /// </summary>
        ...
        /// from the current 'Started' state based on the user's role.
        /// </returns>
        /// <remarks>
        /// Code Ownership: Simon Hinterreiter (hintsimo)
        /// </remarks>
        ...
        // ----------------------------------------------
        /// <summary>
        /// Attempts to transition from the 'Started' state to the specified target state, 
